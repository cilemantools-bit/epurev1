              ...
              <div className="p-6 space-y-4">
                ...
                <div className="space-y-2 text-sm text-slate-600">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-slate-800">{villa.surface}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Chambres:</span>
                    <span className="font-medium text-slate-800">{villa.rooms}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Jardin privatif:</span>
                    <span className="font-medium text-slate-800">{villa.garden}</span>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-6">
                <div className="space-y-4">
                  <h4 className="text-xl font-semibold text-slate-800">Caractéristiques</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-slate-600">Surface utile</p>
                      <p className="text-lg font-medium text-slate-800">{selectedVilla.surface}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-600">Chambres</p>
                      <p className="text-lg font-medium text-slate-800">{selectedVilla.rooms}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-600">Jardin</p>
                      <p className="text-lg font-medium text-slate-800">{selectedVilla.garden}</p>
                    </div>
                    <div>
                      <p className="text-sm text-slate-600">Prix</p>
                      <p className="text-lg font-medium text-slate-800">{selectedVilla.price}</p>
                    </div>
                  </div>
                </div>

                <div className="space-y-4">
                  <h4 className="text-xl font-semibold text-slate-800">Espaces & Équipements</h4>
